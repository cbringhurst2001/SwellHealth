...
import static com.example.swellhealth.DBStructure.DATE;
import static com.example.swellhealth.DBStructure.MONTH;
import static com.example.swellhealth.DBStructure.YEAR;
...
public class DBOpenHelper extends SQLiteOpenHelper {
    ...
    private final static String CREATE_EVENTS_TABLE = "create table " +DBStructure.EVENT_TABLE_NAME+"(ID INTEGER PRIMARY KEY AUTOINCREMENT, "
            + DBStructure.EVENT+" TEXT, " + DATE+" TEXT, " + DBStructure.MONTH+" TEXT, " + DBStructure.YEAR+" TEXT)";
